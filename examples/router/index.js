    ...
    ***************************************************************************** */
    ...
    var BaseHistory = /** @class */ (function () {
        ...
        BaseHistory.prototype.transitionTo = function (location, onComplete, onAbort) {
            ...
            this.confirmTransition(route, function (route) {
    ...
    var VueRouter = /** @class */ (function () {
        ...
        VueRouter.prototype.push = function (location, onComplete, onAbort) {
            ...
            if (!onComplete && !onAbort && typeof Promise !== 'undefined') {
                return new Promise(function (resolve, reject) {
                    _this.history.push(location, resolve, reject);
                });
            }
            else {
        ...
        VueRouter.prototype.replace = function (location, onComplete, onAbort) {
            ...
            if (!onComplete && !onAbort && typeof Promise !== 'undefined') {
                return new Promise(function (resolve, reject) {
                    _this.history.replace(location, resolve, reject);
                });
            }
            else {
    ...
    var install = function (Vue) {
        ...
        var registerInstance = function (vm, callVal) {
            var _a, _b;
            var hook = (_b = (_a = vm.$options.componentVnode) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.registerRouteInstance;
        ...
        Vue.mixin({
            beforeCreate: function () {
                if (this.$options.router) {
                    ...
                    defineReactive$1(this, '_route', this._router.history.current);
                }
                else {
