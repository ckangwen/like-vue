  ...
  ***************************************************************************** */
  ...
  var Vue = /** @class */ (function () {
      function Vue(options) {
           ...
           * 例如Vue.mixin()
           * */
          if (globalConfig$1.setOptions) {
              globalConfig$1.setOptions(this, options);
          }
          else {
  ...
  var initWatch = function (vm, watch) {
      vm.$watch = function (expOrFn, cb, options) {
  ...
  var createWatcher = function (vm, expOrFn, handler, options) {
