(function () {
  ...
  ***************************************************************************** */
  ...
  function computedMergeSStrategy(parent, child) {
      if (!parent)
          return child;
  ...
  Vue$1.config.set('optionMergeStrategies.computed', computedMergeSStrategy);
  var computedPlugin = {
  ...
  //   }
  // }
  // export function defineComputed(target: Vue, key: string, userDef: any) {
  //   // 默认computed应该缓存
  //   if (typeof userDef === 'function') {
